...
class MultiUploadAdmin(admin.ModelAdmin):
    class Media:
        js = (
            'blog/jquery/jquery.1.8.0.min.js',
            'blog/jquery/jquery_fix_csrf.js',
            'blog/jquery/jquery.ui.widget.js',
            'blog/jquery/tmpl.min.js',
            'blog/jquery/canvas-to-blob.min.js',
            'blog/jquery/load-image.min.js',
            'blog/jquery/jquery.iframe-transport.js',
            'blog/jquery/jquery.fileupload.js',
            'blog/jquery/jquery.fileupload-fp.js',
            'blog/jquery/jquery.fileupload-ui.js',
        )
        css = {
            'all': ['blog/css/jquery-ui.css',
                    'blog/css/jquery.fileupload-ui.css',
                    'blog/css/multiupload.css',
                    ],
        }
    change_form_template = 'blog/change_form.html'
    change_list_template = 'blog/change_list.html'
    multiupload_template = 'blog/upload.html'
